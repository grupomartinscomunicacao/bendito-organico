...
|--------------------------------------------------------------------------
|
| Sem estas traduções o Laravel cai no fallback em inglês, e o cliente vê
| "The customer name field is required" no meio de um checkout em português.
|
*/
...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Nomes padrão. Form Requests específicos podem sobrescrever via
    | attributes(), como fazem o checkout e o cadastro de produtos.
    |
    */
